# code to calculate count of amino acids present 3 positions upstream and 3 positions downstream of Cysteine in a peptide sequence 
#### Author: Harshita
# user should modify code according to his need, provided enough commenting
